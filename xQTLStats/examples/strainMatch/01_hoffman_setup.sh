...
#change file names 
bs -c kruglyakWG.cfg list projects 
bs -c kruglyakWG.cfg download project -i 460515063 -o /data2/strainMatch/fastqN/ --extension=fastq.gz
cd /data2/strainMatch/fastqN
mkdir /data2/strainMatch/fastq
find . -name "*.fastq.gz" -exec mv {} /data2/strainMatch/fastq/ \; 
