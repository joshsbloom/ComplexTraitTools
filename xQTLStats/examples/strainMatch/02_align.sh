...
root_dir='/data2/strainMatch/' #/data2/xQTL/FluconazoleV1_041825/'
...
keyfile='/data2/strainMatch/SampleSheet.csv'
#on hoffman2
...
#delete extra line at the end of the file
sname=($(tail -n 384 ${keyfile} | cut -d ',' -f 1 ))
...
do 
    ...
    bwa mem -t $nthreads -R '@RG\tID:${t}\tSM:{$t}' ${genome} ${fastq_dir}/${t}_S${var}_L001_R1_001.fastq.gz ${fastq_dir}/${t}_S${var}_L001_R2_001.fastq.gz | \
