# general Mixed model code for variance analysis
...
# alg derivative based algorithm ('ai' = average information, 'fs' = fisher scoring, or 'nr' = newton-rhapson (fastest to slowest) )
...
calcMM = function(y, B=NULL,X=NULL, Z=NULL, Ze=NULL, reps=FALSE,
                     alg='ai', conv.val=1e-5, Var=NULL, doGPU=FALSE){
